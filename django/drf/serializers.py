...
class gauge_station_source_data_Serializer(GeoFeatureModelSerializer):
    class Meta:
        ...
        geo_field = 'geom'
        id_field = 'obs_id'
        fields = ('obs_id','source_id','station_id','station_name','timemark','time','water_level','wind_speed','air_pressure','tz','units','gauge_owner','data_source','source_name','source_archive','location_name','location_type','country','state','county')
...
class gauge_station_Serializer(GeoFeatureModelSerializer):
    class Meta:
        ...
        geo_field = 'geom'
        id_field = 'station_id'
        fields = ('station_id','station_name','tz','gauge_owner','location_name','location_type','country','state','county')
